...
cont: >
    <h3>MH Editor - Редактор часов техобслуживания</h3>
    <p>
        Приложение для редактирования часов технического обслуживания оборудования, интегрированного с ПЛК Siemens S7.
        Разработано на Python с использованием библиотек Tkinter и SNAP7. Позволяет изменять значения времени технического обслуживания непосредственно в DB-блоках контроллера через интуитивный графический интерфейс.
    </p>
    <a href="img/screenshots/mh_editor.png" data-lightbox="mh_editor" data-title="Редактор моточасов">
        <img src="img/screenshots/mh_editor.png" alt="Редактор моточасов" class="img-responsive">
    </a>
    <a href="https://github.com/SemonoffArt/rh_editor" class="btn btn-default">
