...
cont: >
    ...
    <p>
        ...
        Разработано на Python с использованием библиотек Tkinter и SNAP7. Позволяет изменять значения времени ТО непосредственно в DB-блоках контроллера через интуитивный графический интерфейс.
    </p>
