...
cont: >
    ...
    <p>
        Приложение для управления часами технического обслуживания промышленного оборудования, интегрированного с ПЛК Siemens S7.
        Реализовано на Python (Tkinter) и предназначено для удобного чтения/записи значений времени ТО непосредственно в DB-блоки контроллера через пользовательский интерфейс..
    </p>
